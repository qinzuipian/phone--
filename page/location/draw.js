    ...
    * 绘制矩形完成后，派发的事件接口
    ...
    DrawingManager.prototype._bindCircle = function () {
        ...
        var startAction = function (e) {
            ...
            mask.enableEdgeMove(); 
            mask.addEventListener('touchmove', moveAction);
            baidu.on(document, 'touchend', endAction);
        }
        ...
        var endAction = function (e) {
            ...
            mask.removeEventListener('touchmove', moveAction);
            baidu.un(document, 'touchend', endAction);
        }
        ...
        mask.addEventListener('touchstart', mousedownAction);
    }
    ...
    DrawingManager.prototype._bindPolylineOrPolygon = function () {
        ...
        var startAction = function (e) {
            ...
            if (!isBinded) {
                isBinded = true;
                mask.enableEdgeMove();
                mask.addEventListener('touchmove', mousemoveAction);
        ...
        var dblclickAction = function (e) {
            ...
            isBinded = false;
            mask.disableEdgeMove();
            mask.removeEventListener('touchmove', mousemoveAction);
    ...
    DrawingManager.prototype._bindRectangle = function () {
        ...
        mask.addEventListener('touchstart', startAction);
    }
    ...
    Mask.prototype._bind = function () {
         ...
         */
        var events = ['click', 'touchstart', 'touchmove', 'touchend', 'dblclick'],
            index = events.length;
        while (index--) {
        ...
        baidu.on(container, 'touchmove', function (e) {
